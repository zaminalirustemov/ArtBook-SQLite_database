...
class ArtActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(info.equals("new")){
            ...
            while (cursor.moveToNext()){
                ...
                binding.editTextArtYear.setText(cursor.getString(yearIx))

                val byteArray = cursor.getBlob(imageIx)
                val bitmap = BitmapFactory.decodeByteArray(byteArray,0,byteArray.size)
                binding.imageViewArtImage.setImageBitmap(bitmap)
            }
    ...
    fun saveClicked(view: View) {
        ...
        val artYear=binding.editTextArtYear.text.toString()
                ...
                if(intentFromResult != null){
                    ...
                    try {
                        if (Build.VERSION.SDK_INT>=28){
                            ...
                            binding.imageViewArtImage.setImageBitmap(selectedBitmap)
                        }else{
